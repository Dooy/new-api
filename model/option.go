...
func InitOptionMap() {
	...
	common.OptionMap["CacheTokenAsInputEnabled"] = strconv.FormatBool(common.CacheTokenAsInputEnabled)
	// Dooy 2026-05-24 end
	...
	// dooy 2026-05-27 组管理员密码配置初始化
	common.OptionMap["GroupAdmins"] = setting.GroupAdmins2JSONString()
	// dooy end
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		// Dooy 2026-05-24 begin
		case "CacheTokenAsInputEnabled":
			common.CacheTokenAsInputEnabled = boolValue
		// Dooy 2026-05-24 end
		case "DrawingEnabled":
	...
	case "GroupAdmins":
		err = setting.UpdateGroupAdminsByJSONString(value)
	// dooy end
